  ...
  useEffect(() => {
    const $ = {
      ...
      datGui(){
        ...
        hemiFolder.add(this.hemiLight,'intensity',0,1,0.1)
        hemiFolder.add(this.hemiLight,'visible')
        hemiFolder.add(this.hemiLight.position,'x',-20,20,0.1)
        hemiFolder.add(this.hemiLight.position,'y',-20,20,0.1)
        hemiFolder.add(this.hemiLight.position,'z',-20,20,0.1)
        hemiFolder.open()
      },
      helpers() {
        // 创建辅助坐标系
