  ...
  useEffect(() => {
    const $ = {
      ...
      loadTextures(){
        ...
        const texture = textureLoader.load('/src/assets/textures/earth/earth_atmos_2048.jpg')
        ...
        const metalTexture = textureLoader.load('/public/textures/Warning_Sign_HighVoltage_001/Warning_Sign_HighVoltage_001_opacity.jpg')
      ...
      datGui(){
        ...
        // gui.add(this.box.material,'displacementScale',0,1,0.1)
        ...
        // gui.add(this.box.material,'envMapIntensity',0,1,0.1)

        gui.add(this.box.material,'shininess',0,100,1)
        gui.addColor({color:0x00ffff},'color').onChange(val=>{
          this.box.material.specular = new THREE.Color(val)
        })
      },
      helpers() {
        // 创建辅助坐标系
